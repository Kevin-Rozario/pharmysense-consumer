      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">PharmySense</span>
            </div>
            <p className="text-neutral-300 max-w-md leading-relaxed">
              Connecting you to trusted pharmacies in your community. Find,
              filter, and navigate to healthcare services with ease.
            </p>
          </div>
        ...
        <div className="border-t border-neutral-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="text-neutral-400 text-sm">
            © 2025 PharmySense. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
